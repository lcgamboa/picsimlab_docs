...
\hrefb{pdf/How to use MPLABX to program and debug PICsimLab.pdf}{Tutorial: how to use MPLABX to program and debug PICsimLab}.
...
\section{avr-gdb Debug (simavr) \label{gdbavr}}
